...
printf "\n**BSON plain **\n" >> allbench.txt
weighttp -n $NUM http://gospel99.herokuapp.com/msg/ -H "Accept: application/x-bson" -c $PLL -t 2 >> allbench.txt
printf "\n**BSON gzip **\n" >> allbench.txt
weighttp -n $NUM http://gospel99.herokuapp.com/msg/ -H "Accept: application/x-bson" -H "Accept-encoding: gzip" -c $PLL -t 2 >> allbench.txt
